...
(function () {
    ...
    if (typeof Html5QrcodeCtor !== 'function') {
        throw new Error('Html5Qrcode is not loaded (include html5-qrcode script before this file)');
    }
    ...
    function showResult(status, message, participant) {
        ...
        if (participant && typeof participant === 'object') {
            ...
            const at = participant.checked_in_at ?? '';
            resultParticipant.innerHTML = `
    ...
    startBtn.addEventListener('click', async () => {
        ...
        try {
            if (!html5Qr) {
                html5Qr = new Html5QrcodeCtor(readerId);
            }
